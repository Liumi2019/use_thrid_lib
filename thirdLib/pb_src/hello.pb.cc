...
static void InitDefaultsscc_info_Person_hello_2eproto() {
  ...
  {
    void* ptr = &::persion::_Person_default_instance_;
    new (ptr) ::persion::Person();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::persion::Person::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_hello_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::persion::Person, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::persion::Person, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::persion::Person, name_),
  PROTOBUF_FIELD_OFFSET(::persion::Person, age_),
  PROTOBUF_FIELD_OFFSET(::persion::Person, sex_),
  ~0u,
  0,
  ~0u,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 8, sizeof(::persion::Person)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::persion::_Person_default_instance_),
};

const char descriptor_table_protodef_hello_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013hello.proto\022\007persion\"=\n\006Person\022\014\n\004name"
  "\030\001 \001(\t\022\020\n\003age\030\002 \001(\005H\000\210\001\001\022\013\n\003sex\030\003 \003(\010B\006\n"
  "\004_ageb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_hello_2eproto = {
  false, false, descriptor_table_protodef_hello_2eproto, "hello.proto", 93,
...
Person::Person(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:persion.Person)
}
Person::Person(const Person& from)
  ...
  age_ = from.age_;
  // @@protoc_insertion_point(copy_constructor:persion.Person)
}
...
Person::~Person() {
  // @@protoc_insertion_point(destructor:persion.Person)
  SharedDtor();
...
void Person::Clear() {
// @@protoc_insertion_point(message_clear_start:persion.Person)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "persion.Person.name"));
          CHK_(ptr);
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedBoolParser(_internal_mutable_sex(), ptr, ctx);
          CHK_(ptr);
        } else if (static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24) {
          _internal_add_sex(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* Person::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:persion.Person)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // repeated bool sex = 3;
  if (this->_internal_sex_size() > 0) {
    target = stream->WriteFixedPacked(3, _internal_sex(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:persion.Person)
  return target;
}

size_t Person::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:persion.Person)
  size_t total_size = 0;
  ...
  // repeated bool sex = 3;
  {
    unsigned int count = static_cast<unsigned int>(this->_internal_sex_size());
    ...
    _sex_cached_byte_size_.store(cached_size,
...
// @@protoc_insertion_point(generalized_merge_from_start:persion.Person)
  GOOGLE_DCHECK_NE(&from, this);
  const Person* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Person>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:persion.Person)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:persion.Person)
    MergeFrom(*source);
  }
}

void Person::MergeFrom(const Person& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:persion.Person)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:persion.Person)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:persion.Person)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::persion::Person* Arena::CreateMaybeMessage< ::persion::Person >(Arena* arena) {
  return Arena::CreateMessageInternal< ::persion::Person >(arena);
}
